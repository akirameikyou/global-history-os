...
{
id:'manjiro_ny_departure_1870',
source:{author:'中浜明',title:'中浜万次郎の生涯',publisher:'富山房',published:'1970-12-10',pages:'277–279頁'},
type:'person',
startYear:1870,
timelineVisible:false,
routeLabel:'MINNESOTA',
title:'ニューヨーク出港',
year:'1870.11',
description:'1870年11月2日、視察団一行はアメリカ船ミネソタ号でニューヨークを出港し、大西洋を横断してリバプールへ向かう。',
cardText:'1870年11月2日、普仏戦争視察団の一行はアメリカ船ミネソタ号（Minnesota）でニューヨークを出港した。大西洋を約二週間かけて横断し、イギリスのリバプール港へ向かう。\n\n〔原典の日付について〕出典には「十二月二日」とあるが、同書記載の「二週間後・十一月十六日リバプール着」および翌十七日ロンドン着との行程上の整合から、「十一月二日」の誤植と判断した。画面表示は11月2日とする。',
note:'原典（中浜明『中浜万次郎の生涯』277–279頁付近）は出港日を「十二月二日」と記すが、二週間後の11/16リバプール着・翌11/17ロンドン着と両立せず、新旧暦でも説明できないため「十一月二日」の誤植と判断。原典表記と判断理由を保存する。',
lat:40.7128,
lng:-74.0060,
placeName:'New York',
lineColor:'#66e0ff',
...
arcVisible:false,
routeType:'voyage',
routeName:'ATLANTIC / NEW YORK — LIVERPOOL (Minnesota)',
defaultSegmentStatus:'documented',
routePoints:[
  {label:'New York',            lat:40.71, lng:-74.01, nodeType:'port',         historicalStatus:'documented', transport:'steamship'},
  {label:'NW Atlantic',         lat:43.00, lng:-58.00, nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Mid Atlantic',        lat:48.50, lng:-38.00, nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'NE Atlantic',         lat:50.50, lng:-22.00, nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'SW of Ireland',       lat:51.00, lng:-12.00, nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Celtic Sea',          lat:51.20, lng:-7.50,  nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:"St George's Channel", lat:52.00, lng:-5.80,  nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Irish Sea',           lat:53.20, lng:-4.80,  nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Liverpool Bay',       lat:53.55, lng:-3.35,  nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Liverpool',           lat:53.41, lng:-3.00,  nodeType:'port',         historicalStatus:'documented', transport:'steamship'}
],
relatedEvents:['manjiro_liverpool_1870']
},

{
id:'manjiro_liverpool_1870',
source:{author:'中浜明',title:'中浜万次郎の生涯',publisher:'富山房',published:'1970-12-10',pages:'277–279頁'},
type:'person',
startYear:1870,
timelineVisible:false,
routeLabel:'LIVERPOOL',
title:'リバプール入港',
year:'1870.11',
description:'1870年11月16日、視察団一行はアメリカ船ミネソタ号で大西洋を横断し、イギリスのリバプール港に入った。',
cardText:'ニューヨークを出港して約二週間後の1870年11月16日、視察団一行はアメリカ船ミネソタ号で大西洋を横断し、イギリスのリバプール港に入った。ここから汽車で一晩かけてロンドンへ向かう。',
note:'リバプール→ロンドンは鉄道。イギリス国内の陸上を通す形状用の非表示ウェイポイントを用いる（途中駅への立ち寄りを示すものではない）。',
lat:53.41,
lng:-3.00,
placeName:'Liverpool',
lineColor:'#66e0ff',
...
arcVisible:false,
routeType:'voyage',
routeName:'RAIL / LIVERPOOL — LONDON (overnight)',
defaultSegmentStatus:'documented',
routePoints:[
  {label:'Liverpool', lat:53.41, lng:-3.00, nodeType:'port',         historicalStatus:'documented', transport:'rail'},
  {label:'Cheshire',  lat:53.20, lng:-2.30, nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'rail'},
  {label:'Midlands',  lat:52.55, lng:-1.45, nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'rail'},
  {label:'Chilterns', lat:51.90, lng:-0.75, nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'rail'},
  {label:'London',    lat:51.51, lng:-0.13, nodeType:'port',         historicalStatus:'documented', transport:'rail'}
],
relatedEvents:['manjiro_second_america']
},
...
title:'ロンドン到着',
year:'1870.11',
description:'リバプールから汽車で一晩かけて移動し、1870年11月17日、視察団一行はロンドンに到着した。視察ののち、地中海・スエズ運河・香港・神戸を経て帰国する。',
cardText:'リバプールから汽車で一晩かけて移動し、十一月十七日、視察団一行はロンドンに到着した。\n\n視察ののち帰路につき、地中海からスエズ運河・紅海・香港・神戸を経て横浜へ帰着する。帰路の細かな航跡は史料に確定がなく、当時の航行条件をもとに再構成している。',
note:'①NY→リバプール→ロンドンは史料で確認できる。②リバプール→ロンドンは鉄道移動。③ロンドン以後は海路（地中海→スエズ運河→紅海→インド洋→香港→神戸→横浜）。④スエズ・香港・神戸・横浜などの主要地点は史料に基づく。⑤英国の出港港・途中の寄港地・細かな航跡は未確認。⑥中間点は航路形状を整える推定点であり、寄港地ではない。⑦shapeOnly:true の地点は画面上の地点マークやカードを生成しない。日付：NY出港1870/11/2、リバプール着1870/11/16、ロンドン着1870/11/17、神戸着1871/2/26（明治4正月8日）、横浜着1871/3/2。',
lat:51.5074,
lng:-0.1278,
placeName:'London',
lineColor:'#66e0ff',
...
arcVisible:false,
routeType:'voyage',
routeName:'EUROPE RETURN / LONDON — MEDITERRANEAN — SUEZ — HONG KONG — KOBE — YOKOHAMA',
defaultSegmentStatus:'estimated',
routePoints:[
  // ロンドンを出て、テムズ河口→ドーバー海峡→英仏海峡→ビスケー湾→イベリア沖→ジブラルタル→地中海→ポートサイド（海上・形状用）
  {label:'London',            lat:51.51, lng:-0.13,  nodeType:'port',         historicalStatus:'documented', transport:'steamship'},
  {label:'Thames Estuary',    lat:51.45, lng:0.90,   nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Dover Strait',      lat:50.95, lng:1.50,   nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'English Channel',   lat:50.00, lng:-1.50,  nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Off Ushant',        lat:48.30, lng:-5.60,  nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Bay of Biscay',     lat:45.50, lng:-6.50,  nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Off NW Iberia',     lat:43.00, lng:-10.00, nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Off Lisbon',        lat:38.50, lng:-10.00, nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Strait of Gibraltar',lat:35.95,lng:-5.60,  nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Alboran Sea',       lat:36.00, lng:-2.00,  nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'West Mediterranean',lat:37.80, lng:4.00,   nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'South of Sardinia', lat:38.00, lng:9.00,   nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Sicily Channel',    lat:36.80, lng:12.00,  nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Central Mediterranean',lat:34.50,lng:18.00,nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'South of Crete',    lat:34.00, lng:24.00,  nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Off North Egypt',   lat:32.20, lng:30.00,  nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Port Said',           lat:31.25, lng:32.30,  nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Suez Canal',          lat:30.60, lng:32.35,  nodeType:'port',        historicalStatus:'documented', transport:'steamship'},
  // 以下スエズ〜香港の中間点は「寄港地」ではなく、海路の形状を制御する非表示の補間点。
  // shapeOnly:true。routePointsはカード・ラベル・クリック点を生成しない（描画専用）。
  // 紅海→バブ・エル・マンデブ→アデン湾→アラビア海→インド南方→アンダマン海→マラッカ海峡→南シナ海の海上をなぞる。
  {label:'Gulf of Suez',        lat:27.50, lng:34.00,  nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Red Sea North',       lat:23.50, lng:37.00,  nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Red Sea Central',     lat:19.00, lng:39.80,  nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Red Sea South',       lat:14.50, lng:42.20,  nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Bab-el-Mandeb',       lat:12.50, lng:43.50,  nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Gulf of Aden',        lat:12.30, lng:47.50,  nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Arabian Sea West',    lat:13.50, lng:55.00,  nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Arabian Sea',         lat:11.00, lng:63.00,  nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Laccadive Sea',       lat:6.50,  lng:73.50,  nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'South of Sri Lanka',  lat:4.50,  lng:81.00,  nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Bay of Bengal South', lat:4.00,  lng:88.00,  nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Andaman Sea',         lat:7.50,  lng:94.00,  nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Off Aceh',            lat:6.50,  lng:96.50,  nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Malacca Strait North',lat:5.20,  lng:98.60,  nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Malacca Strait Mid',  lat:4.00,  lng:99.60,  nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Malacca Strait',      lat:3.00,  lng:100.60, nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Malacca Strait South',lat:2.20,  lng:101.80, nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Singapore Strait',    lat:1.30,  lng:104.10, nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'South China Sea South',lat:8.00, lng:110.00, nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'South China Sea',     lat:15.00, lng:113.50, nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Hong Kong',           lat:22.32, lng:114.17, nodeType:'port',        historicalStatus:'documented', transport:'steamship'},
  // 香港→神戸：台湾・琉球・九州・四国を避け海上を通す（形状用）
  {label:'Luzon Strait',      lat:21.00, lng:121.00, nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'East of Taiwan',    lat:25.00, lng:125.00, nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Philippine Sea',    lat:29.00, lng:130.00, nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'South of Kyushu',   lat:31.00, lng:131.50, nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Off Shikoku',       lat:32.50, lng:133.50, nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Kii Channel',       lat:33.60, lng:135.00, nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Kobe',              lat:34.69, lng:135.20, nodeType:'port',        historicalStatus:'documented', transport:'steamship'},
  // 神戸→横浜：紀伊半島を避け太平洋岸を通す（形状用）
  {label:'Kii Suido',         lat:34.00, lng:135.00, nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Pacific S of Kii',  lat:33.30, lng:135.70, nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Off Kii Peninsula', lat:33.60, lng:137.50, nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Enshu Nada',        lat:34.10, lng:138.50, nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'South of Izu',      lat:34.20, lng:139.20, nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Sagami Bay',        lat:34.80, lng:139.48, nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Uraga Channel',     lat:35.05, lng:139.78, nodeType:'routeControl', historicalStatus:'estimated', shapeOnly:true, transport:'steamship'},
  {label:'Yokohama',          lat:35.44, lng:139.64, nodeType:'port',        historicalStatus:'documented', transport:'steamship'}
],
...
title:'アヘン戦争',
year:'1839 — 1842',
description:'イギリスと清の戦争によって、東アジアの海上秩序と欧米諸国との関係が大きく変化した。',
cardText:'1839年、アヘン貿易をめぐる対立からイギリスと清の戦争が始まった。清は敗れ、1842年の南京条約によって香港島の割譲や港の開放を受け入れた。西洋の軍艦と武力を伴う通商要求は、東アジア諸国に大きな衝撃を与えた。',
meaning:'清の敗北は、幕府に従来の異国船打払政策を再考させる要因となった。万次郎が漂流した1841年は、東アジアの国際秩序が大きく揺らいでいた時期にあたる。',
manjiroRelation:'万次郎が直接関与した戦争ではない。漂流・救助・渡米の時期に東アジアで進行していた国際環境として表示する。',
placeJa:'中国沿岸・香港',
color:'#ff5e5e',
lat:22.3,
lng:114.1,
...
title:'米墨戦争',
year:'1846 — 1848',
description:'アメリカとメキシコの戦争の結果、カリフォルニアを含む広大な地域がアメリカ領となった。',
cardText:'1846年、アメリカとメキシコの間で戦争が始まった。1848年の講和によって、メキシコはカリフォルニアを含む広大な北部領土をアメリカへ譲った。その直後、カリフォルニアで金が発見され、世界各地から人びとが流入することになる。',
meaning:'戦争による領土の移動と金の発見が重なり、カリフォルニアは短期間で太平洋交通の重要な拠点へ変化した。万次郎が帰国資金を求めて向かった土地が、どのように形成されたかを示す。',
manjiroRelation:'万次郎は戦争へ直接関与していない。戦後にアメリカ領となったカリフォルニアへ渡り、金鉱で働いた。',
placeJa:'アメリカ南西部・メキシコ北部',
color:'#ff5e5e',
lat:29.42,
lng:-98.49,
...
year:'1848 — 1855',
description:'金の発見をきっかけに世界各地から人びとが集まり、カリフォルニアとサンフランシスコが急速に発展した。',
cardText:'1848年、カリフォルニアで金が発見されると、翌年から世界各地の人びとが金鉱地帯へ押し寄せた。サンフランシスコは、人・物資・船が集まる太平洋側の玄関口として急速に成長した。\n\n万次郎は1849年にフェアヘーブンを出発し、ケープホーンを回ってサンフランシスコへ向かった。そこから金鉱地帯へ入り、帰国のための資金を得た。',
meaning:'ゴールドラッシュは、北米大陸と太平洋を結ぶ人の流れを加速させた。万次郎にとっては、世界的な人口移動の中へ自ら入り、帰国を実現するための資金を得る機会となった。',
manjiroRelation:'万次郎が自ら参加した世界史イベント。ここで得た資金が、仲間を迎えに行き、日本へ帰るための具体的な力になった。',
placeJa:'カリフォルニア・サンフランシスコ',
color:'#ffd95e',
lat:37.77,
lng:-122.42,
...
title:'黒船来航',
year:'1853',
description:'ペリー率いるアメリカ艦隊が浦賀沖に現れ、大統領の国書を幕府へ提出した。',
cardText:'1853年、ペリー率いる4隻のアメリカ艦隊が浦賀沖へ来航した。蒸気軍艦を含む艦隊の姿と、武力を背景にした外交要求は、幕府と諸藩に大きな衝撃を与えた。ペリーはアメリカ大統領の国書を渡し、翌年に回答を受け取るため再来航すると告げて去った。',
meaning:'黒船来航は、日本が世界の海上交通と国際外交へ向き合う転換点となった。海の外を実体験として知る万次郎の知識が、幕府にとって現実的な価値を持つようになった。',
manjiroRelation:'万次郎は黒船に乗って来航したのではなく、幕府側の人材として召し出された。アメリカの言語・制度・航海事情を知る経験が評価された。',
placeJa:'浦賀・江戸湾',
color:'#b58cff',
lat:35.24,
lng:139.72,
...
title:'日米和親条約',
year:'1854',
description:'日本とアメリカの間で最初の条約が結ばれ、下田・箱館の開港や漂流民の保護などが定められた。',
cardText:'1854年、再来航したペリーと幕府の交渉により、日米和親条約が神奈川で締結された。条約では、アメリカ船へ薪・水・食料などを供給するため下田と箱館を開くこと、漂流民を保護すること、アメリカ領事を下田に置くことなどが定められた。\n\nこれは直ちに自由貿易を始める条約ではなかったが、長く制限されていた日米間の公式な関係を開く第一歩となった。',
meaning:'漂流民が国外へ流れ着き、帰国そのものを疑われた時代から、外国船と漂流民の扱いを条約で定める時代へ移る転換点である。日本の対外関係は、拒絶を基本とする対応から、外交交渉による関係形成へ変わり始めた。',
manjiroRelation:'万次郎は条約の正式な交渉当事者ではない。幕府に登用され、アメリカと航海に関する知識を提供した人物として、開国対応を支える側に位置していた。',
placeJa:'神奈川・横浜',
color:'#66e0ff',
lat:35.44,
lng:139.64,
...
title:'アメリカ南北戦争',
year:'1861 — 1865',
description:'奴隷制と国家のあり方をめぐる対立からアメリカが南北に分裂し、大規模な内戦となった。',
cardText:'1861年、アメリカ合衆国から離脱した南部諸州と、連邦を維持しようとする北部との間で南北戦争が始まった。戦争は1865年まで続き、多くの人命と社会基盤が失われた。戦争の過程で奴隷解放が進み、終結後のアメリカ社会にも大きな変化を残した。\n\n1862年にホイットフィールド船長が万次郎へ送った手紙には、国内の争いが深刻な結果を招きかねないこと、戦争は生命と財産を失わせるが、避けられない場合もあるという認識が記されている。',
meaning:'南北戦争は遠い外国の出来事であると同時に、万次郎が暮らしたアメリカの家族や友人たちが直面していた現実だった。ホイットフィールドの手紙を通して、世界史上の戦争が個人間の関係へ届く様子が見える。',
manjiroRelation:'万次郎は南北戦争へ参加していない。1862年のホイットフィールド書簡を通して、かつて暮らしたアメリカの内戦を知ったと考えられる。',
placeJa:'アメリカ合衆国',
color:'#ff5e5e',
lat:38.0,
lng:-78.5,
...
description:'生麦事件をめぐる対立から、イギリス艦隊と薩摩藩が鹿児島で交戦した。',
cardText:'1863年、生麦事件への賠償と犯人処罰を求めるイギリスと薩摩藩の交渉が決裂し、鹿児島湾で戦闘が起きた。イギリス艦隊の砲撃によって鹿児島の市街地にも被害が出た一方、薩摩側の砲撃もイギリス艦隊に損害を与えた。\n\n戦後、薩摩藩はイギリスと関係を築き、西洋の軍事・航海・造船技術を積極的に学ぶ方向へ進んだ。',
meaning:'外国との武力衝突が、単純な排斥ではなく、相手の技術と制度を学ぶ必要性の認識へ転じた事例である。衝突後の薩摩では、西洋知識を持つ人材の価値がさらに高まった。',
manjiroRelation:'万次郎は薩英戦争そのものには参加していない。戦後の1864年、薩摩藩に招かれ、開成所で航海・測量・英語などを教えた。',
placeJa:'鹿児島湾・鹿児島',
color:'#ff5e5e',
lat:31.60,
lng:130.56,
...
title:'明治維新',
year:'1868 — 1869',
description:'幕府から新政府へ政治権力が移り、戊辰戦争を経て新しい国家体制の建設が始まった。',
cardText:'1868年、王政復古と新政府の成立によって、江戸幕府を中心とした政治体制は大きく転換した。旧幕府勢力と新政府軍の戦いは戊辰戦争として各地へ広がり、1869年まで続いた。新政府はその後、中央集権化と近代国家建設を進めていく。',
meaning:'幕末に例外的だった海外知識は、明治になると国家建設に必要な知識へ変わった。一方で、時代の中心は幕府の対外対応から、新政府による制度・教育・産業の整備へ移っていった。',
manjiroRelation:'万次郎は政治変革の中心人物ではない。1869年に開成学校の教授となり、幕末に得た英語と海外経験を明治期の教育へ引き継いだ。',
note:'表示区間は維新の転換期（戊辰戦争 1868–1869）で区切る。以後の「明治の世」は背景であり、万次郎の明治期イベント（開成学校・欧州・晩年）が担う。',
placeJa:'京都・江戸／東京・日本',
color:'#7dff7a',
lat:35.68,
lng:139.76,
